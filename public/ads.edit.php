...
<html>
    ...
    <body>
        ...
        <!-- Form Name -->
        <legend>Edit this listing</legend>
        ...
        <!-- Image -->
        <div class="form-group">
          <label class="col-md-4 control-label" for="file">Change Image</label>
          <div class="col-md-4">
        ...
        <div class="form-group">
          ...
          <div class="col-md-4">
            ...
            <button id="submit_ad" name="submit_ad" class="btn btn-primary">Save Changes</button>
          </div>
        </div>
