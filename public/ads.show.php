      ...
      <div class="col-md-6">
        ...
        <div id="slider" class="flexslider">
          ...
          <div class="flex-viewport" style="overflow: hidden; position: relative;">
            <ul class="slides clearfix" style="width: 1200%; transition-duration: 0s; transform: translate3d(0px, 0px, 0px);">
              ...
              <li style="width: 555px; float: left; display: block;">
                <a href="img/product_large_2.jpg" data-lightbox="true">
                  <img src="img/product_large_2.jpg" alt="" draggable="false">
                  <i class="arrow_expand"></i>
                </a>
              </li>
              <li style="width: 555px; float: left; display: block;">
                <a href="http://deothemes.com/envato/amadea/html/img/product_large_1.jpg" data-lightbox="true">
                  <img src="http://deothemes.com/envato/amadea/html/img/product_large_1.jpg" alt="" draggable="false">
                  <i class="arrow_expand"></i>
                </a>
              </li>
        ...
        <div id="thumbs" class="flexslider">
          ...
          <div class="flex-viewport" style="overflow: hidden; position: relative;">
            <ul class="slides" style="width: 1200%; transition-duration: 0s; transform: translate3d(0px, 0px, 0px);">
             <!-- <li class="flex-active-slide" style="width: 103px; float: left; display: block;">
                <img src="http://deothemes.com/envato/amadea/html/img/product_large_1.jpg" alt="" draggable="false">
              </li>-->
              <!--<li style="width: 103px; float: left; display: block;">
                <img src="http://deothemes.com/envato/amadea/html/img/product_large_1.jpg" alt="" draggable="false">
              </li>-->
              <!--<li style="width: 103px; float: left; display: block;">
                <img src="http://deothemes.com/envato/amadea/html/img/product_large_1.jpg" alt="" draggable="false">
              ...
              <!--<li style="width: 103px; float: left; display: block;">
                <img src="img/thumb_6.jpg" alt="" draggable="false">-->
              </li>
            </ul>
          </div>
          <ul class="flex-direction-nav">
